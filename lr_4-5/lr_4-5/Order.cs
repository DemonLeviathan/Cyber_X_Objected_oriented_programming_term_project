...
namespace lr_4_5
{
    internal class Order
    {
        ...
        public int user_id, hour_quantity, total_price, computer_number;
        ...
        public Order(int user_id, string date_start, string time_start, int hour_quantity, string order_name, int total_price, int computer_number)
        {
